  ...
  return (
    <section className="px-6 md:px-8 py-16 md:py-24 bg-surface border-t border-border">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          {steps.map((step) => (
            <div key={step.number} className="relative">
              <div className="text-7xl font-bold text-border leading-none mb-4 select-none">
                {step.number}
              </div>
        ...
        {/* Trust block */}
        <aside className="bg-highlight border border-blue-200 rounded-xl p-5 flex gap-3 items-start">
